...
final readonly class LicenseDTO
{
    ...
    public static function createListFromCsv(string $licenses): array
    {
         ...
         * 21:'Photo',
         * 22:'Saison',
         * 23:'"Saison première licence"',
         * 25:'Discipline(s)',
         * 25:'"Catégorie âge sportif"',
         * 26:'"Catégorie âge"',
         * 27:'Mutations',
         * 28:'Surclassement',
         * 29:'"Date de demande"',
         * 30:'"Date compta"',
         * 31:'"Date de début"',
         * 32:'"Date de fin de validité"',
         * 33:'Honorabilité',
         * 34:'"Montant licence"',
         * 35:'"Options licence"',
         * 36:'"Montant options"',
         * 37:'"Type certificat"',
         * 38:'"Date de début certificat médical"',
         * 39:'"Date de fin certificat médical"',
         * 40:'"Code structure"',
         * 41:'"Nom structure"',
         * 42:'"Nom court structure"',
         * 43:'"Adresse structure"',
         * 44:'"Commune structure"',
         * 45:'"Code postal structure"',
         * 46:'"Mail structure"',
         * 47:'"Téléphone structure"',
         * 48:'"Mobile structure"',
         * 49:'"Code Comité Départemental"',
         * 50:'"Nom Comité Départemental"',
         * 51:'"Code Comité Régional"',
         * 52:'"Nom Comité Régional"',
         * 53:'"Nom du responsable légal"',
         * 54:'"Prénom du responsable légal"',
         * 55:'"Téléphone du responsable légal"',
         * 56:'"Mail du responsable légal"',
         * 57:'"Nom du responsable légal secondaire"',
         * 58:'"Prénom du responsable légal secondaire"',
         * 59:'"Téléphone du responsable légal secondaire"',
         * 60:'"Mail du responsable légal secondaire"',
         */
